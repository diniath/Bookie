...
public class DatabaseConfig {
    ...
    @Bean(name = "sessionFactory")//This will be a bean so that we inject it into our DAOs
    public LocalSessionFactoryBean sessionFactory(){
        LocalSessionFactoryBean sessionFactory = new LocalSessionFactoryBean();
        sessionFactory.setDataSource(datasource());
        sessionFactory.setHibernateProperties(hibernateProperties());
        sessionFactory.setPackagesToScan("diniath.entity");
        return sessionFactory;
    }
    //Declare TransactionManager
    @Bean
    @Autowired //we can use it either with fields, or methods, or constructors - Here: Inject a SessionFactory Object into this method argument
